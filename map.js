...
//////////////////////////////////////////////////////////////////////////////////////////
const map = L.map('map').setView([35.135992218926006, 136.97550412883587], 13);      // https://leafletjs.com/reference.html#map-example を参照
    ...
    allLocationsData.forEach(data => {
        ...
        if (areaMatch && districtMatch) {
            ...
            // マーカーにポップアップコンテンツを紐付け
                 // https://leafletjs.com/reference.html#layer-bindpopup を参照
            marker.bindPopup(popupContent)// マーカーを地図に配置mar
